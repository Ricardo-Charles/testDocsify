...
<p>如果你觉得课程不错，从中有所收获的话，不要忘了推荐给身边的朋友哦，希望大家都有所提高、不断成长。</p>
...
##### *坤：
> 这份课程，我一遍都还没有学完，这次直接来到最后一课，写个评论，这个课程真的很好，从开始的一无所知何茫然到春招能找到一份工作，也是运气好，刚好那个二面面试官，问得好几个并发问题，答的很好，还用了课程中的例子，哈哈，老师真的很棒，比看书效率高，而且清晰明了。加油，以后多看几遍，😂

##### *齐：
> 第三遍刷这个专栏了，第一遍通读，第二遍边看边做笔记，第三遍回味。毫不保留的说，这是我读过的最好的并发专栏。2021-02-07，思齐。

##### **峰：
> 希望老师出更多 Java 相关的课程，讲的太好了

##### *仁：
> 终于看完了，不说学了多少记住了多少，至少脉络已经清晰了。谢谢老师

##### **明：
> 学完这门课程收益颇丰,谢谢您!

##### *文：
> 利用下班时间看了一周才看完，讲的可以，收获颇多，我还得消化一下，准备出去找工作了，希望用的上😁

 ###### &nbsp;&nbsp;&nbsp; 编辑回复：
> &nbsp;&nbsp;&nbsp; 加油~ 祝你成功！

##### **亮：
> 课程看完了，收货满满，若要深入研究，还是需要多看看书的，并发编程，JMM模型，CPU之间都是存在前后联系的。

##### **生：
> 受益匪浅

##### **威：
> 本来看着约到后边，留言越少，原来都憋着劲 最后一天热闹呢 课程超级棒哇 加油 加油

##### **栓：
> 课程总结的非常棒，还需要多看多消化，上下班地铁上看非常合适
